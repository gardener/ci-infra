...
helm template -n ingress-nginx ingress-nginx ingress-nginx/ingress-nginx --version "4.9.1" -f $SCRIPT_DIR/values.yaml > $SCRIPT_DIR/../ingress-nginx-deployment.yaml
